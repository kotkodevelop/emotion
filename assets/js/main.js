...
document.addEventListener("DOMContentLoaded", () => {
    ...
    favs.forEach(btn => {
        // ставим стартовую иконку
        btn.innerHTML = btn.classList.contains('is-fav') ? svgActive : svgDefault;
